...
const Contact = () => {
  return (
    <div className="md:px-20">
      <div className="grid h-[350px] items-center rounded-3xl bg-white text-center text-[16px] text-dark sm:h-[350px] md:h-[550px] md:grid-cols-2 md:rounded-none">
        <div className="">
          <div className="mb-6 text-[30px] text-dark sm:text-[40px]">
        ...
        <div className="relative hidden h-[550px] md:flex">
          <Image
